# zoezi-pelvix-starter - COMPLETE

A Zoezi component that allows logged-in users to start their PelviX treatment session.

---

## Configuration

**Component Name:** `zoezi-pelvix-starter`
...
1. Add the component to a page in Zoezi page builder
2. Configure the `apiUrl` prop to point to your Replit backend
3. The component will show login prompt for unauthenticated users
4. Logged-in users see the "Start PelviX" button
